...
public class HCurve {
    ...
    private List<ArrayList<Point>> curves2 = new ArrayList<ArrayList<Point>>();
    ...
    */
    public Point getNewpoint(Point A, Point B, Point C) {
        ...
        normal = normal.multBy(25.0);
        Random rn = new Random();

        return new Point(C.getX()+normal.getX()+rn.nextInt(27),
        				C.getY()+normal.getY()+rn.nextInt(30)); 
    }
}
